...
GBird::GBird(const Color& c, const std::string& app, const short& w, const short& h, const short& st, const COORD& p, const RECT& gb)
	: Animal()
{
	color		= c;
	appearance	= app;
...
void GBird::Draw(const short& start, const short& end)
{
