...
void Button::Draw()
{
	Graphics::DrawTexts(GetStdHandle(STD_OUTPUT_HANDLE), title, pos, (int)color);
}
void Button::Draw(Color cl)
{
	Graphics::DrawTexts(GetStdHandle(STD_OUTPUT_HANDLE), title, pos, (int)cl);
}